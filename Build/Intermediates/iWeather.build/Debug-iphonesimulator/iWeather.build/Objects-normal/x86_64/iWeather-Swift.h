...
#ifndef IWEATHER_SWIFT_H
#define IWEATHER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iWeather",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8iWeather10APIService")
...
SWIFT_CLASS("_TtC8iWeather11AppDelegate")
...
SWIFT_CLASS("_TtC8iWeather15LocationManager")
...
SWIFT_CLASS("_TtC8iWeather13SceneDelegate")
...
SWIFT_CLASS("_TtC8iWeather24SearchCityViewController")
@interface SearchCityViewController : UIViewController <UISearchBarDelegate>
...
SWIFT_CLASS("_TtC8iWeather19SearchCityViewModel")
@interface SearchCityViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8iWeather11WeatherCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified degrees;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified latlong;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8iWeather21WeatherViewController")
...
SWIFT_CLASS("_TtC8iWeather16WeatherViewModel")
